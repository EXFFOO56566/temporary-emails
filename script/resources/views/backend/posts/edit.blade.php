                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        id="title" name="title" value="{{ $post->title }}" required placeholder="Titel">
                                    @error('title')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        id="slug" name="slug" value="{{ $post->slug }}" required placeholder="Slug">
                                    @error('slug')
                                    <div class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric" name="lang" id="language">
                                        ...
                                        <option value="{{ $language->code}}" @if($post->lang == $language->code)
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric" name="status">
                                        <option value="1" {{ $post->status == 1 ? 'selected' : '' }}>{{__('Publish')}}
                                        </option>
                                        <option value="0" {{ $post->status == 0 ? 'selected' : '' }}>{{__('Draft')}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control @error('mete_title') is-invalid @enderror"
                                        name="mete_title" value="{{ $post->mete_title }}"
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                        ...
                                        placeholder="Description">{{ $post->meta_description }}</textarea>
